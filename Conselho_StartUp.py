...
def main() -> None:
    st.set_page_config(page_title="Multi-agentes para projetos e start ups reviews", layout="wide")
    init_session_state()
    
    st.title("Multi-agentes para projetos e start ups reviews")
    ...
    with st.sidebar:
        ...
        openai_api_key = st.text_input(
            ...
            help="Enter your OpenAI API key to continue (or set OPENAI_API_KEY in .env)"
        )
